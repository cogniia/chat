        ...
        await update({ password: newPassword })
            .then(async () => {
                ...
                setDescriptionDialog(
                    "Utilize sua nova senha ao realizar um novo acesso à plataforma.",
                );
            ...
            .catch((_) => {
                ...
                setDescriptionDialog(
                    "Houve um problema de comunicação em nosso servidor e não foi possível alterar sua senha no momento. Por favor tente novamente mais tarde.",
                );
                setCancelButtonDialog("Voltar para seu perfil");
                setErrorDialog(true);
                setShowDialog(true);
        ...
        <section className="relative h-full flex flex-col items-center p-4 pt-16">
            ...
            <div className="max-w-4xl w-full flex flex-col">
                <div className="w-full mb-4">
                    <BreadcrumbComponent
                        key={"bread"}
                        tree={[{ name: "Seu Perfil", path: "/profile" }]}
                        currentPage={{ name: "Alterar Senha" }}
                    />
                </div>
                ...
                <div className="mt-24 flex relative flex-col">
                    <Label className="text-[16px] text-grey-800 mb-8">
                        Para alterar sua senha de acesso, preencha o primeiro
                        campo com a senha que utiliza atualmente para acessar a
                        plataforma, e o segundo campo com sua nova senha.
                    </Label>
